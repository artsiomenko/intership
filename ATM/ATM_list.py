...
class TestATM(unittest.TestCase):
    ...
    def test_get_15(self):
        ...
        self.assertEqual(atm.get(15), {(10, 5), (5, 5, 5)})

    def test_get_120(self):
        atm = ATM({5: 2, 10: 1, 50: 2, 60: 2, 100: 1})
        self.assertEqual(atm.get(120), {(60, 50, 5, 5), (100, 10, 5, 5), (60, 50, 10), (60, 60), (50, 50, 10, 5, 5)})

    def test_get_515(self):
        atm = ATM({5: 1, 10: 1, 50: 4, 100: 2, 200: 2})
        self.assertEqual(atm.get(515), {(200, 100, 50, 50, 50, 50, 10, 5), (200, 100, 100, 50, 50, 10, 5),
                                        (200, 200, 50, 50, 10, 5), (200, 200, 100, 10, 5)})
    ...
    def test_get_speed_after_improvements(self):
        ...
        self.assertEqual(atm.get(30), {(5, 5, 5, 5, 5, 5), (10, 5, 5, 5, 5), (10, 10, 5, 5), (10, 10, 10), (20, 5, 5),
                                       (20, 10)})
    ...
    def test_can_get_10_with_large_number_of_banknotes(self):
        ...
        self.assertEqual(atm.get(20), {(10, 5, 5), (5, 5, 5, 5), (20,), (10, 10)})
    ...
    def test_can_get_3000(self):
        ...
        self.assertEqual(atm.get(3000), {(200, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,
